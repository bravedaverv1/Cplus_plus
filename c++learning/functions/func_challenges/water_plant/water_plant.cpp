...
// Second argument: A bool value is_succulent. (A value of true would indicate that
...
// If is_succulent is true and days is greater than or equal to 13, return "Go ahead and
...
std::string needs_water(int days, bool is_succulent)
{
    ...
    else if (is_succulent == true && days > 12 || days < 12)
    {
        return "Time to water the plant\n";
    }
